...
const baseMessage = (pluginConfig, context, isDryRunMode) => {
  ...
  if (Object.keys(lastRelease).length > 0) {
    facts.push({ title: 'Last Release', value: lastRelease.gitTag })
  }

  facts.push({ title: 'Commits', value: commits.length })
                  ...
                  'columns': [
                    {
                      ...
                      'items': [
                        {
                          'type': 'Image',
                          'url': imageUrl || 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Gitlab_meaningful_logo.svg/144px-Gitlab_meaningful_logo.svg.png',
                          'altText': 'Teams icon',
                          'size': 'medium',
                          'style': 'person'
                        }
            ...
            },
            {
              ...
              'items': [
                ...
                },
                {
                  'type': 'TextBlock',
                  'separator': true,
                  'text': context.nextRelease.notes,
                  'wrap': true
                }
              ]
            }
 ...
 * ]
 */
//  --------- Probably not needed anymore, but keeping it here for now ---------
